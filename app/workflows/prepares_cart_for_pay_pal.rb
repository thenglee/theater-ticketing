class PreparesCartForPayPal < PreparesCart
  ...
  def on_success
    ...
    Rails.logger.info "pay_pal_payment.pay_pal_payment.success?: #{pay_pal_payment.pay_pal_payment.success?}"
    Rails.logger.info "pay_pal_payment.pay_pal_payment.error: #{pay_pal_payment.pay_pal_payment.error}"
    Rails.logger.info "pay_pal_payment.pay_pal_payment.transactions: #{pay_pal_payment.pay_pal_payment.transactions}"
