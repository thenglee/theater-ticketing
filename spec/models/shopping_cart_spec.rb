...
describe ShoppingCart do
  ...
  let(:t1) { instance_double("Ticket", event: romeo,
                             performance: romeo_performance,
                             price: Money.new(1500)) }
  let(:t2) { instance_double("Ticket", event: romeo,
                             performance: romeo_performance,
                             price: Money.new(1500)) }
  let(:t3) { instance_double("Ticket", event: hamlet,
                             performance: hamlet_performance,
                             price: Money.new(1500)) }
